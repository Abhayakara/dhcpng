...
/* Define this if you want to print a summary of allocated memory that
   hasn't been freed when the server exits. */
...
/* This turns of ISC-specific messages. */
